...
Input:
  Two lines, representing a single race (ignore the spaces)
  1. Time: how much time you have to beat the race
  2. Distance: how far you must travel to win
    Example:
    Time:      7  15   30   => '7''15''30' => '71530'
    Distance:  9  40  200   => '9''40''200'=> '940200'
...
Output:
  For part 2, there is only one race.
  Print the count of how many ways you can win.
"""
...
def main():
    with p.open('r') as file:
        race = parse_file(file.read())
    
    n_ways = number_of_ways_to_win(race)
    print(n_ways)
    
    print("Ways to win:", n_ways)
